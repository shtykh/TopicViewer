...
public class TopicTest {
	private static final String EXPECTED_PARTITIONS_PAGE = 
			"<html>" +
			...
			"</body>" +
			"</html>";
	private static final String EXPECTED_STATISTICS_PAGE = 
			"<html>" +
	...
	public void testGetPartitionDataPage() throws Exception {
		...
		assertEquals(EXPECTED_PARTITIONS_PAGE, partitionDataPage);
	}
	...
	public void testGetStatisticsPage() throws Exception {
		...
		assertEquals(EXPECTED_STATISTICS_PAGE, statisticsPage);
	}
}